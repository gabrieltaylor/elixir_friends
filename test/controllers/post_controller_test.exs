defmodule ElixirFriends.PostControllerTest do
  ...
  test "shows an image for the post", %{conn: conn} do
    post = Repo.insert %Post{image_url: "http://theneotraditionalist.com/wp-content/uploads/2015/03/Chicago-14-09-7331-1024x682-1024x682.jpg"}
    conn = get conn, post_path(conn, :show, post)
    assert html_response(conn, 200) =~ "Show post"
    assert html_response(conn, 200) =~ "<img src='http://theneotraditionalist.com/wp-content/uploads/2015/03/Chicago-14-09-7331-1024x682-1024x682.jpg' />"
  end
